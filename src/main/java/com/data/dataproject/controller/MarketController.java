...
public class MarketController {
    ...
    public ResponseEntity<MarketDto> getMarket(@PathVariable Long marketId) {
        return ResponseEntity.ok().body(marketService.getMarketInfo(marketId));
    }
    ...
    public ResponseEntity<ProductDto> getProduct(@PathVariable Long marketId, @PathVariable String category) {
        return ResponseEntity.ok().body(marketService.getProductInfo(marketId, category));
    }
